...
impl Search {
    ...
    > {
        let mut req = self.client.client.request(
            ...
            format!(
                "{}/{}",
                self.client.base_url, "crm/v3/objects/tickets/search"
            ),
        );
