...
impl Default {
    ...
    #[doc = "Perform a `GET` request to \
             ...
             {AccountSid}/SigningKeys/{Sid}.json.\n\n**Parameters:**\n\n- `account_sid: &'astr` \
             (required)\n- `sid: &'astr` (required)\n\n```rust,no_run\nasync fn \
             example_default_fetch_signing_key() -> anyhow::Result<()> {\n    let client = \
             twilio_api::Client::new_from_env();\n    let result: \
             twilio_api::types::ApiV2010AccountSigningKey = client\n        .default()\n        \
    ...
    #[doc = "Perform a `DELETE` request to \
             ...
             {AccountSid}/SigningKeys/{Sid}.json.\n\n**Parameters:**\n\n- `account_sid: &'astr` \
             (required)\n- `sid: &'astr` (required)\n\n```rust,no_run\nasync fn \
             example_default_delete_signing_key() -> anyhow::Result<()> {\n    let client = \
             twilio_api::Client::new_from_env();\n    client\n        .default()\n        \
