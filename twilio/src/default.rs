...
impl Default {
    ...
    #[doc = "Perform a `POST` request to `/2010-04-01/Accounts/{AccountSid}/Usage/Triggers.json`.\n\nCreate a new UsageTrigger\n\n**Parameters:**\n\n- `account_sid: &'astr`: The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that will create the resource. (required)\n\n```rust,no_run\nasync fn example_default_create_usage_trigger() -> anyhow::Result<()> {\n    let client = twilio_api::Client::new_from_env();\n    let result : twilio_api::types::ApiV2010AccountUsageUsageTrigger = client . default () . create_usage_trigger (\"some-string\" , & twilio_api::types::CreateUsageTriggerRequest { callback_url : \"https://example.com/foo/bar\" . to_string () , trigger_value : \"some-string\" . to_string () , usage_category : twilio_api::types::UsageTriggerEnumUsageCategory :: MarketplaceWhitepagesProPhoneIntelligence , callback_method : Some (twilio_api::types::CreateUsageTriggerRequestCallbackMethod :: Delete) , friendly_name : Some (\"some-string\" . to_string ()) , recurring : Some (twilio_api::types::UsageTriggerEnumRecurring :: Yearly) , trigger_by : Some (twilio_api::types::UsageTriggerEnumTriggerField :: Count) }) . await ? ;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
